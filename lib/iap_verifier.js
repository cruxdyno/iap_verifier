...
(function() {
  ...
  IAPVerifier = (function() {
    ...
    function IAPVerifier(_at_password, _at_production, _at_debug, _at_timeout) {
      this.password = _at_password;
      this.production = _at_production != null ? _at_production : true;
      this.debug = _at_debug != null ? _at_debug : false;
        ...
        return function(valid, msg, data) {
          ...
          if ((21007 === (data != null ? data.status : void 0)) && (_this.productionHost === _this.host)) {
            ...
            return _this.verify(receiptData, options, function(valid, msg, data) {
              if (this.debug) {
                console.log("STATUS " + (data != null ? data.status : void 0));
              }
      ...
      request = https.request(options, (function(_this) {
        return function(response) {
          ...
          response.on('end', function() {
            var err, responseData, totalData;
